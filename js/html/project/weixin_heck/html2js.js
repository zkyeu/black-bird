...
window["html2js"]["html/weixin_body.html2js.html"] = "<div class=\"clear-fix heck_center\" v-cloak @click=\"updateNew\">\n" +
    ...
    "                          v-if=\"(wxData.localInfo.is_trust != 1) && false\" @click=\"sendCircleFriend\">\n" +
    ...
    "                    <span @click=\"userOpShow\" :class=\"{'is-new' : isNew('main')}\" v-if=\"false\">\n" +
    "                        <i></i>\n" +
    "                        <i></i>\n" +
    "                        <i></i>\n" +
    ...
    "                        <li :class=\"{'is-new' : isNew('main', '1')}\" relNew=\"main|1\" @click=\"blackUseTips('show')\">注意事项</li>\n" +
    "                        <li :class=\"{'is-new' : isNew('main', '2')}\" relNew=\"main|2\" @click=\"myStudy\">我的学员</li>\n" +
    ...
    "                <!-- 分类 -->\n" +
    "                <user-types :local-info=\"wxData.localInfo\" v-if=\"false\"></user-types>\n" +
    "                <!-- 搜索 -->\n" +
    ...
    "                        <!--</ul>-->\n" +
    "                    </dd>\n" +
    "                    <dd class=\"user_list_label_s\" @click=\"showLabelEdit($event, x);\" :class=\"{isOpen : x == showLabelEditor}\" v-show=\"false\"></dd>\n" +
    "                </template>\n" +
    "            </dl>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "\n" +
    "                    <!--聊天窗口右侧菜单-->\n" +
    "                    <template v-if=\"false\"><!--隐藏菜单功能 20170721 李亮-->\n" +
    "                        <template v-if=\"wxData.msgList[wxData.curUserId].isGroup\">\n" +
    "                            <div class=\"user-menu\" :class=\"{'is-new' : isNew('chatGroup')}\" v-if=\"!isHelper(wxData.curUserId)\" @click=\"userOptShow\" tabindex=\"-1\" @blur=\"userOptHide\">\n" +
    ...
    "                                        </li>\n" +
    "                                        <li :class=\"{'is-new' : isNew('chatGroup', '1')}\" relNew=\"chatGroup|1\" @click=\"editNameShow(wxData.msgList[wxData.curUserId].isGroup, wxData.msgList[wxData.curUserId].userInfo.c_remark || wxData.msgList[wxData.curUserId].userInfo.nick )\">修改群备注名 </li>\n" +
    "                                        <li :class=\"{'is-new' : isNew('chatGroup', '2')}\" relNew=\"chatGroup|2\" @click=\"groupMenuSet('myNicker')\">修改群昵称</li>\n" +
    ...
    "                        </template>\n" +
    "                        <template v-else>\n" +
    "                            <div class=\"user-menu\" :class=\"{'is-new' : isNew('chatSingle')}\"  v-if=\"!isHelper(wxData.curUserId)\" @click=\"userOptShow\" tabindex=\"-1\" @blur=\"userOptHide\">\n" +
    "                                <div class=\"user-menu-list\" v-show=\"userOpt.show\" transition=\"trans1\">\n" +
    "                                    <ul>\n" +
    "                                        <li :class=\"{'is-new' : isNew('chatSingle', '1')}\" relNew=\"chatSingle|1\"  @click=\"editNameShow(wxData.msgList[wxData.curUserId].isGroup, wxData.msgList[wxData.curUserId].userInfo.c_remark || wxData.msgList[wxData.curUserId].userInfo.nick )\">\n" +
    "                                            修改备注\n" +
    "                                        </li>\n" +
    "                                        <li :class=\"{'is-new' : isNew('chatSingle', '2')}\" relNew=\"chatSingle|2\"  @click=\"showUserDetail(wxData.msgList[wxData.curUserId].userInfo.id)\">\n" +
    "                                            微信信息\n" +
    "                                        </li>\n" +
    ...
    "                    <dl v-for=\"x in wxData.msgList[wxData.curUserId].userMsg\" :class=\"x.isCC ? 'mes_right' : 'mes_left'\">\n" +
    "                        <!--系统-->\n" +
    ...
    "                                    wxData.msgList[wxData.curUserId].userInfo.nick) }} <span>{{ x.msg_time }}</span></h6>\n" +
    "                                <!-- 撤回 -->\n" +
    ...
    "                                <!--<pre v-if=\"x.msg_type == 1\" class=\"mes_con\">{{{ x.msg_content }}}</pre>-->\n" +
    "\n" +
    "                                <!--<pre v-if=\"x.msg_type == 0\" class=\"mes_con\">{{ x.msg_content }}</pre>-->\n" +
    "\n" +
    "                                <!--@人消息-->\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"user_message\" v-show=\"false\">\n" +
    "        <span class=\"wx_mask\" v-if=\"setGroupChat.flag\"></span>\n" +
    ...
    "                                            <div class=\"bind-menu\">\n" +
    "                                                <div class=\"bind-menu-style\" :class=\"{'is-new' : isNew('infoSingle')}\" @click=\"showBindMenuList\" tabindex=\"-1\" @blur=\"hideBindMenuList\"></div>\n" +
    "                                                <div class=\"bind-menu-group\" v-show=\"cutUserMenuList\" transition=\"trans1\">\n" +
    "                                                    <ul>\n" +
    "                                                        <li :class=\"{'is-new' : isNew('infoSingle', '1')}\" relNew=\"infoSingle|1\" @click=\"setAutoSend\">设置自动发送</li>\n" +
    "                                                        <li :class=\"{'is-new' : isNew('infoSingle', '2')}\" relNew=\"infoSingle|2\" @click=\"recommendUser\">推荐学员</li>\n" +
    "                                                        <li @click=\"introWechat('show',wxData.msgList[wxData.curUserId].crmInfo.user_id)\">转介绍二维码</li>\n" +
    ...
    "                                        <!--绑定后的菜单-->\n" +
    "                                        <div class=\"bind-menu-style\" :class=\"{'is-new' : isNew('infoGroup')}\"  name=\"bind-menu-style\" @click=\"groupBindMenu\" v-show=\"bindGroupCtl.canselBindGroup\">\n" +
    "                                            <div class=\"bind-menu-group\" transition=\"trans1\" name=\"bind-menu-group\" v-show=\"bindGroupCtl.menu\">\n" +
    "                                                <ul>\n" +
    "                                                    <li :class=\"{'is-new' : isNew('infoGroup', '1')}\" relNew=\"infoGroup|1\" name=\"setAutoSend\">\n" +
    "                                                        <a :href=\"bindGroupCtl.groupDetail.commodityUrl\" target=\"_blank\">商品详情</a>\n" +
    "                                                    </li>\n" +
    "                                                    <li :class=\"{'is-new' : isNew('infoGroup', '2')}\" relNew=\"infoGroup|2\" name=\"recommendUser\" class=\"class-detail-layer\">\n" +
    "                                                        班级信息\n" +
    ...
    "    <div class=\"user_search\" style=\"float: left;\">\n" +
    ...
    "        <em id=\"send_article_btn\" @click=\"show\" title=\"发送文章\" :class=\"{'red-point':redPoint.newflag}\"></em>\n" +
    ...
    "                            <li :class=\"{'cut-tab': $index+1 == articleCurrentPage, 'red-points':redPoint.type.indexOf($index+1) > -1 }\" v-for=\"x in navlist\" @click=\"getArticle($index+1)\">\n" +
    "                                {{ x }}\n" +
    "                            </li>\n" +
    "                        </ul>\n" +
    "                        <!--搜索-->\n" +
    ...
    "                                    <div>\n" +
    "                                        <p><font>{{{x.title | filterKey}}}</font><i v-if=\"x.newflag == 1\">NEW</i></p>\n" +
